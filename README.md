...
Semantic Scholar + OpenAlex + bioRxiv, concurrent) → dedupe → DeepSeek synthesis
with strict citations → two-panel bilingual UI`
...
| bioRxiv (preprints) | ✅ integrated (fail-soft; via Crossref, member 54368/openRxiv, institution=bioRxiv — keyword search since bioRxiv's own API has none) |
